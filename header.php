...
<nav class="navbar navbar-inverse  navbar-fixed-top"  role="navigation" >
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="view.php">
                        <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span> Images</a></li>
               ...
               <ul class="nav navbar-nav navbar-right">
                   ...
                   <li><a  href="login.php" data-toggle="modal" data-target="#loginModal"><span class="glyphicon glyphicon-log-in"></span> login</a></li>
                   <li><a href="logout.php" data-toggle="modal" data-target="#loginModal"><span class="glyphicon glyphicon-log-in"></span> <?php echo isset($_SESSION["customer_name"])?$_SESSION["customer_name"]:"Hello Guest";?></a></li>
